...
class ZeitungSpider(scrapy.Spider):
    ...
    name = 'augsburger_allgemeine_spider'
    ...
    def parse(self, response):
        ...
        hrefs = response.xpath('//div[contains(@class, "section")]/div[contains(@class, "teaser")]//@href').extract()
    ...
    def parse_story(self, response):
        ...
        date = response.xpath('//p[contains(@class, "date")]/text()').extract_first()

        author = response.xpath('//span[@class="author"]/text()').extract_first()

        article_text = response.xpath('//div[contains(@class, "article_text")]/p/text()').extract()
